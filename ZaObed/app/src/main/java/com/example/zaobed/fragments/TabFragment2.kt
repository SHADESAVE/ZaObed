...
import kotlinx.android.synthetic.main.tab_layout_2.view.*

class TabFragment2: Fragment() {
    private val adapter = TabAdapter()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.tab_layout_2, container, false)

        view.rv_tab2.adapter = adapter
        view.rv_tab2.layoutManager = LinearLayoutManager(context)
        view.rv_tab2.setHasFixedSize(true)
//        view.rv_tab2.addOnScrollListener(object : RecyclerView.OnScrollListener() {
